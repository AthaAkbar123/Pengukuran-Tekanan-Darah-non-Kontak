...
OUTPUT_FOLDER = os.path.join(os.getcwd(), 'output_results')  # Folder untuk menyimpan hasil
...
def main():
    ...
    # Ambil semua gambar PNG dari folder
    ...
    # Dictionary untuk menyimpan sinyal RGB per ROI
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                for roi_name, (indices, color) in roi_definitions.items():
                    ...
                    if roi.size > 0:
                        # Menyimpan nilai rata-rata sinyal RGB
